...
public class MyFeedAdapter extends RecyclerView.Adapter<MyFeedAdapter.ViewHolder> {
  ...
  public MyFeedAdapter(Context context, List<Feed> feedList, FeedClickedListener listener) {
  ...
  @Override public void onBindViewHolder(final ViewHolder holder, int position) {
    ...
    holder.feedImage.setImageResource(feedList.get(position).getImageResourceID());
